...
-- ----------------------------
INSERT INTO `tp_admin_user` VALUES ('1', 'admin', '超级管理员', 'e10adc3949ba59abbe56e057f20f883e', '1517120152', '127.0.0.1', '388', 'tianpian0805@gmail.com', '13121126169', '我是超级管理员', '1', '0', '1222907803', '1451033528');
...
-- ----------------------------
INSERT INTO `tp_product` VALUES ('1', '2', '', '菠萝菠萝蜜', '菠萝菠萝蜜好吃', '50.00', '60.00', '', '20', '这是介绍', 'Y', 'Y', '0', '0');
...
CREATE TABLE `tp_product_sku` (
  ...
  PRIMARY KEY (`id`),
  KEY `product_id` (`product_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='产品sku表';

-- ----------------------------
-- Records of tp_product_sku
-- ----------------------------
INSERT INTO `tp_product_sku` VALUES ('1', '1', '50g', '50.00', '20', 'Y', '1517023313', '1517023313');
...
) ENGINE=MyISAM AUTO_INCREMENT=241 DEFAULT CHARSET=utf8 COMMENT='网站日志';
